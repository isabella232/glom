  ...
  m_label_table_name(0)
{
  ...
  m_button_field_formatting->signal_clicked().connect( sigc::mem_fun(*this, &Dialog_Layout_Export::on_button_field_formatting) );
...
void Dialog_Layout_Export::set_document(const Glib::ustring& layout, Document_Glom* document, const Glib::ustring& table_name, const type_vecLayoutFields& table_fields)
{
  m_modified = false;
...
void Dialog_Layout_Export::save_to_document()
{
...
void Dialog_Layout_Export::on_button_field_formatting()
{
  try
  {
