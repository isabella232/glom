...
bool Box_Data_List_Related::refresh_data_from_database_with_foreign_key(const Glib::ValueBase& foreign_key_value)
{
...
void Box_Data_List_Related::on_record_added(const Glib::ValueBase& primary_key_value, const Gtk::TreeModel::iterator& row)
{
...
void Box_Data_List_Related::on_record_deleted(const Glib::ValueBase& /* primary_key_value */)
{
...
void Box_Data_List_Related::get_suitable_record_to_view_details(const Glib::ValueBase& primary_key_value, Glib::ustring& table_name, Glib::ValueBase& table_primary_key_value) const
{
  //Initialize output parameters:
  table_name = Glib::ustring();
  table_primary_key_value = Glib::ValueBase();
