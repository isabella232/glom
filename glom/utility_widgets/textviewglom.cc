...
void TextViewGlom::check_for_change()
{
  ...
  if(new_text != m_old_text)
  {
    ...
    Gnome::Gda::Value value = GlomConversions::parse_value(m_glom_type, new_text, layout_item->m_numeric_format, success);
...
Gnome::Gda::Value TextViewGlom::get_value() const
{
  ...
  return GlomConversions::parse_value(m_glom_type, pNonConstThis->m_TextView.get_buffer()->get_text(true), layout_item->m_numeric_format, success);
}
